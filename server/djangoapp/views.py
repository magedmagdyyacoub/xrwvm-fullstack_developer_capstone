...
# Create a `get_cars` view to get the list of cars
...
#     return render(request, 'dealer_reviews.html', {'reviews': reviews})
...
#         )
#         review.save()
#         return redirect('get_dealer_reviews', dealer_id=request.POST['dealer_id'])
